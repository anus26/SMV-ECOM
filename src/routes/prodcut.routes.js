...
productrouter.post("/add",upload.array("images",2),authmiddleware,authorizationRole("seller"), productadd)
productrouter.put("/update/:id", 
    upload.array("images",2),authmiddleware,authorizationRole("seller"),
     updateproduct)
